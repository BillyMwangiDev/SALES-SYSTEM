"""
Django settings for Nicmah System project.
"""
...
ROOT_URLCONF = 'nicmah_system.urls'
...
WSGI_APPLICATION = 'nicmah_system.wsgi.application'
...
# Crontab settings for automated backups
CRONJOBS = [
    ('0 2 * * *', 'core.cron.daily_backup'),  # Daily at 2 AM
]
